...
export default function PurpleDashboard() {
  ...
  return (
    <div className="min-h-screen pb-24"
      ...
      {overlayPage && (
        <div className="fixed inset-0 z-[400] bg-white/80" style={{ backdropFilter: "blur(4px)" }}>
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 flex justify-around items-center pt-2.5 pb-[18px]"
        style={{ background: "rgba(232,224,250,.90)", backdropFilter: "blur(18px)", borderTop: "1px solid rgba(255,255,255,.82)", boxShadow: "0 -4px 28px rgba(118,84,168,.08)" }}>
        {(["🤍","💬","🎀","⭐","🎵"] as const).map((icon, i) => {
